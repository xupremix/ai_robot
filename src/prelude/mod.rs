...
pub const ACTOR_LR: f64 = 0.01;
pub const CRITIC_LR: f64 = 0.02;
pub const OBSERVATION_SPACE: i64 = 4;
pub const ACTION_SPACE: i64 = 4;
pub const DEFAULT_MAP_PATH: &'static str = "src/save/maps/test_normal_map.bin";
...
pub const REWARD_FOR_ILLEGAL_ACTION: f64 = -2.0;
